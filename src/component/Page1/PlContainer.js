...
class PlContainer extends React.Component{
    ...
    componentDidUpdate(prevProps,prevState){if(prevProps.Data!==this.props.Data){this.setState(this.props.Data)}}
    render(){return (<div className={s.PLcontainer}>
        <ProdList formAC={this.props.formAC} deleteIdAC={this.props.deleteIdAC} 
        ReqData={this.props} option={this.props.option}/></div>)}}
